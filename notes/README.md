...
- [Study Plan](unit2/00_unit2_study_plan.md)
- [Divide and Conquer](unit2/01_divide_and_conquer.md)
- [Binary Search](unit2/02_binary_search.md)
- [Binary Search Variants](unit2/03_binary_search_variants.md)
- [Merge Sort](unit2/04_merge_sort.md)
- [Inversion Count](unit2/05_inversion_count.md)
- [Quick Sort](unit2/06_quick_sort.md)
- [Heap and Heap Sort](unit2/07_heap_and_heap_sort.md)
- [Strassen Matrix Multiplication](unit2/08_strassen_matrix_multiplication.md)
- [Graph Representations](unit2/09_graph_representations.md)
- [DFS and BFS](unit2/10_dfs_bfs.md)
- [Connected Components](unit2/11_connected_components.md)
